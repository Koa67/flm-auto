...
-- Index for lookups
CREATE INDEX IF NOT EXISTS idx_safety_ratings_generation ON safety_ratings(generation_id);
CREATE INDEX IF NOT EXISTS idx_safety_ratings_stars ON safety_ratings(stars);
